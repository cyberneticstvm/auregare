                ...
                <form method="post" action="{{ route('blog.save') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            <label>Type</label><br>
                            {{ html()->select($name='type', $value=array('Blog'=>'Blog', 'Guide'=>'Guide'))->class('form-control')->placeholder('Select Type')->required()}}
                        </div>
                        <div class="col-6 mt-3">
                            <label>Blog Category</label><br>
                            {{ html()->select($name='category', $value=$categories->pluck('name', 'id'), '')->class('form-control')->placeholder('Select Blog Category')->required()}}
                        </div>

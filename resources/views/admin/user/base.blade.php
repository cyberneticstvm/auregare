...
<head>
    <meta charset="utf-8">
    <title>Aurega Real Estate Admin</title>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('/web/assets/images/logo/favicon.ico') }}" type="image/x-icon">
    <!-- Template CSS -->
...
<body>
    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        <div class="aside-top">
            <a href="{{ route('user.dash') }}" class="brand-wrap">
                <img src="{{ asset('/web/assets/images/logo/aurega-logo-transparent.png') }}" class="logo" alt="Aurega Dashboard">
            </a>
            <div>
        ...
        <nav>
            <ul class="menu-aside">
                <li class="menu-item {{ (in_array(request()->segment(1), ['dash'])) ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('user.dash') }}"> <i class="icon material-icons md-home"></i>
            ...
            <div class="col-nav">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false"> <img class="img-xs rounded-circle" src="{{ asset('/admin/assets/imgs/people/avatar1.jpg') }}" alt="User"></a>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                            <a class="dropdown-item" href="{{ route('user.dash') }}"><strong>Hi, {{ Auth::user()->name }}</strong></a>
